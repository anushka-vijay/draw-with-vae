...
[![Draw with VAE Demo Video](https://img.youtube.com/vi/8WQHOE-PP3o/maxresdefault.jpg)](https://www.youtube.com/watch?v=8WQHOE-PP3o)
...
Set up your local environment by installing the required libraries listed in `requirements.txt`:
...
Launch the lightweight local development server using Python's built-in HTTP module:

```bash
python -m http.server 8000
```

_(Note: Use `python3` instead of `python` if you are on a Mac or Linux system)._
